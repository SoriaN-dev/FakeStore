...
function testPage() {
    ...
    const y1 = useTransform(scrollYProgress, [0, 0.25, 0.69, 0.7, 0.8, 0.95], [900, 0, 0, 40, 40, 80]);
    ...
    return (
        <div className=" bg-[#101111] w-screen">

            <section className="text-white h-screen flex items-center justify-center ">
                <span className="font-bold text-[80px] font-sfprodisplay">
                    Bienvenidos
                </span>
